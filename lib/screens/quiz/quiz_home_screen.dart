...
class _QuizHomeScreenState extends State<QuizHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: GlassAppBar(title: l10n.quizTitle),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            GlassSectionHeader(title: l10n.chooseQuizType)
                .animate()
                .fadeIn(delay: 200.ms),
            ...
            GlassSectionHeader(title: l10n.recentScores)
                .animate()
                .fadeIn(delay: 700.ms),
            const SizedBox(height: 16),
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                child: const Center(
                  child: Icon(Icons.quiz_rounded, color: Colors.white, size: 32),
                ),
              ),
            ],
          ),
  ...
  Widget _buildQuizTypeCard(
    ...
    return GestureDetector(
      onTap: () => Navigator.push(
        ...
        MaterialPageRoute(
          builder: (_) =>
              QuizListScreen(quizType: data.quizType, title: data.title),
        ),
      ),
      child: GlassCard(
        ...
        child: Column(
          ...
          children: [
            ...
            GlassProgressBar(value: bestScore / 100),
            const SizedBox(height: 4),
            // Label below bar
            Text(
              bestScore > 0
  ...
  Widget _buildRecentScores(BuildContext context) {
    ...
    return Column(
      children: _recentAttempts.asMap().entries.map((entry) {
        ...
        final correct = attempt['correctAnswers'] as int? ?? 0;
        final scorePercent = totalQ > 0 ? (correct / totalQ * 100).toInt() : 0;
        ...
        return Padding(
          ...
          child: GlassTile(
            ...
            title: Text(_quizTypeName(context, quizType)),
            subtitle: Text('$correct/$totalQ ${l10n.correct} · $dateLabel'),
            trailing: Container(
              padding:
          ...
          ).animate().fadeIn(delay: Duration(milliseconds: 800 + index * 60)),
        );
      }).toList(),
    );
  }
