...
class ChallengeModel {
  ...
  final bool isPersonalized;      // selected because it matched user's active categories
  final bool isAutoGenerated;     // generated from content, not from Firestore pool
  final double difficultyMultiplier; // multiplier applied to targetValue at creation
  ...
  String get difficultyTierLabel {
    if (difficultyMultiplier < 0.8) return 'Easy';
    if (difficultyMultiplier <= 1.5) return 'Medium';
    return 'Hard';
  }

  Color get difficultyTierColor {
    if (difficultyMultiplier < 0.8) return const Color(0xFF10B981);
    if (difficultyMultiplier <= 1.5) return const Color(0xFFF59E0B);
  ...
  factory ChallengeModel.fromMap(Map<String, dynamic> map) {
    return ChallengeModel(
      ...
      difficultyMultiplier: (map['difficultyMultiplier'] ?? 1.0).toDouble(),
    );
  }
